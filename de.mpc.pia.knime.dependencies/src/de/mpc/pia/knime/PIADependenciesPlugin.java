 ...
 * @author julianu
 */
public class PIADependenciesPlugin extends Plugin {
    // The shared instance.
    private static PIADependenciesPlugin plugin;

    /**
     * The constructor.
     */
    public PIADependenciesPlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PIADependenciesPlugin getDefault() {
        return plugin;
    }
