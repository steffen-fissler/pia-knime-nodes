 ...
 */
package de.mpc.pia.knime.nodes.filestorageport;
 ...
 *
 * This class is basically copied from com.genericworkflownodes.knime.base.data.port
 *
 * @author aiche
 */
public abstract class AbstractFileStoreURIPortObject extends
    ...
    public String getSummary() {
        ...
        int size = getURIContents().size();
        b.append(size);
        b.append(size == 1 ? " file (extension: " : " files (extensions: ");
        b.append(ConvenienceMethods.getShortStringFrom(getSpec().getFileExtensions(), 3));
        b.append(")");
